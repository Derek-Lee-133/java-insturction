...
public class ProductDB {
	...
	public static Product getProductFromMap(String productCode) {
		...
		javaBook.setDescription("Murach's Java Programmming");
		...
		javaBook.setCode("jsp");
		javaBook.setDescription("Murach's Jsp Programming");
		javaBook.setPrice(35.50);
		javaBook.setAuthor("Joel Murach");

		items.put("jsp", javaBook);
